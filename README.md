...
I turn designs into fast, seamless, responsive, interactive , visually engaging web applications that scale. I highly specialize in transforming ideas and designs into seamless digital experiences using modern technologies.

I use technologies such as Typescript, React, JavaScript, Next.js, Tailwind CSS, PostgresSQL, Git  & GitHub, RESTful API’s to solve real-world problems and improve my skills to stay aligned with industry trends.
